        ...
        <div class="right">
            ...
            <div id="container">
                <div class="form_part w700">
                    ...
                    <form action="resist_final.jsp" method="get" onsubmit="confirm('등록하시겠습니까?');" enctype="multipart/form-data">
                        <h2>일반</h2>
                        <p>카테고리 구분</p>
                        ...
                        <footer class="footer">
                            ...
                            <div class="btn_area">
                                ...
                                <div class="forward"><input type="submit" value="등록하기" id="resist_final"><i class="fa fa-arrow-right" aria-hidden="true"></i></div>
                            </div>
                        </footer>
                    </form>
                </div>
